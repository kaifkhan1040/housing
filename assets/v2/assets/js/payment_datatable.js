...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_basic_table) {
    ...
    tableTitle.innerHTML = 'Payments';
    dt_basic = new DataTable(dt_basic_table, {
      ajax: {
                    url: '/landlord/payment_list',
                    dataSrc: 'data'
                },
      columns: [
      ...
      columnDefs: [
        ...
        // },
        {
         ...
         targets: 3,  // ID column
    render: function (data, type, full, meta) {
      return `<a href="/landlord/dues-view/${data}/" class="text-primary">${data}</a>`;
    }
        },
        {
          ...
          features: [
            {
              buttons: [
                ...
                {
                  text: '<span class="d-flex align-items-center gap-2"><i class="icon-base ti tabler-plus icon-sm"></i> <span class="d-none d-sm-inline-block">Add Records</span></span>',
                  className: 'create-new btn btn-primary',
                  action: function (e, dt, node, config) {
                        window.location.href = '/landlord/dues-add';
                    }
                }
              ]
            }
