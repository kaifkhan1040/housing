  ...
  if (dt_basic_table.length) {
    ...
    render: function (data, type, full, meta) {
      ...
      buttons: [
        {
          extend: 'collection',
          className: 'btn btn-outline-secondary dropdown-toggle mr-2 me-1',
        ...
        {
           text: feather.icons['plus'].toSvg({ class: 'mr-50 font-small-4' }) + 'Add Expenses',
          className: 'create-new btn btn-primary',
          id: "createlisting001",
          action: function (e, dt, node, config) {
            // Redirect to your desired creation page
            window.location.href = "/landlord/expense-add"; // change this URL as needed
          },
          init: function (api, node, config) {
            $(node).removeClass('btn-secondary');
          }
